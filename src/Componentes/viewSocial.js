...
class resultadosFinal1 extends React.Component {
    ...
    render(){
        ...
        let data2 = [this.props.dimensao_social];
        let options = {
 ...
 <View style={{width:'100%', height:50,flexDirection:'row', backgroundColor:'#f4511e', paddingLeft:10, paddingTop:12}}>
   <Text style={{fontSize:23, fontWeight:'bold', color:'#fff', paddingLeft:15, }}>Dimensão Social</Text>
  </View>
 
              <ScrollView style={{ flex: 1, width: null, paddingTop: 10, paddingBottom:15}}>
...
mapStateToProps = state =>(
    {
        ...
        dimensao_social: state.AutenticacaoReducer.social,
...
export default connect(mapStateToProps, null)(resultadosFinal1)