...
class resultadosFinal2 extends React.Component {
    ...
    render(){
        ...
        let data2 = [this.props.dimensao_ambiental];
        let options = {
 ...
 <View style={{width:'100%', height:50,flexDirection:'row', backgroundColor:'#f4511e', paddingLeft:10, paddingTop:12}}>
   <Text style={{fontSize:23, fontWeight:'bold', color:'#fff', paddingLeft:15, }}>Dimensão Ambiental</Text>
  </View>
...
mapStateToProps = state =>(
    {
        ...
        dimensao_ambiental: state.AutenticacaoReducer.ambiental,
